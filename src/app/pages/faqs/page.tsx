  ...
  return (
    <main>
     <div className='container pt-20 lg:pt-0 color-white pl-32 pr-32'>
      ...
      <p><strong>1. How can I contact your customer service? </strong> Our customer service is available all year round, from Monday to Friday, from 9 a.m. to 12 p.m. and from 2 p.m. to 7 p.m. (Central European Time). You can contact us by email at <b> <a href='mailto:contact@corten.plus'>contact@corten.plus </a></b> or use the contact form on our website.</p><br />
      ...
      <p> <strong>12. I can't find my question in the list, what should I do? </strong>Send us an email to <a href='mailto:contact@corten.plus'><b>contact@corten.plus</b></a>, and we will respond as soon as possible.</p><br /> <br /><br />
      </div>
